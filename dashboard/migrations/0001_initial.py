    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(choices=[(1, 'Project manager'), (2, 'Evaluator'), (3, 'Project Accountant'), (4, 'UR SPIU')], default=2)),
                ('project_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='projects.Project')),
                ('user_name', models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='user_profile', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phone_field.models.PhoneField(help_text='Enter Phone Phone', max_length=31)),
                ('position', models.CharField(max_length=250)),
                ('degree', models.PositiveSmallIntegerField(choices=[(1, 'Bachelor'), (2, 'Masters'), (3, 'Phd'), (4, 'Professor')], default=1)),
                ...
                ('gross_salary', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=14)),
